...
public class HighSchoolDbContext :
    AbpDbContext<HighSchoolDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(HighSchoolConsts.DbTablePrefix + "YourEntities", HighSchoolConsts.DbSchema);
        ...
        {
            b.ToTable(HighSchoolConsts.DbTablePrefix + "Courses",
